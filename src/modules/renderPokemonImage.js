const getFemaleImage = (pokemonObj, shiny, direction) => {
    return shiny ? (
        ...
        direction === "front" ? pokemonObj.sprites.front_female : pokemonObj.sprites.back_shiny_female
    )
};

const getMaleImage = (pokemonObj, shiny, direction) => {
  return shiny ? (direction === "front" ? pokemonObj.sprites.front_shiny : pokemonObj.sprites.back_shiny
  ) : (
    direction === "front" ? pokemonObj.sprites.front_shiny : pokemonObj.sprites.back_default;
  )
};
